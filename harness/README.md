...
Fighter attack progression, Studied Attacks, Combat Prowess, Relentless, True Strike, weapon packages, and source-backed resistance handling are evaluated analytically from current code and configuration.
