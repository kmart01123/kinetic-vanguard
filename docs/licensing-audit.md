...
| SRD creature catalog, rosters, and provenance | `harness/data/srd_creatures.json`, `harness/data/srd_creature_rosters.json`, `harness/provenance/srd-creatures.json` | Transcribed and normalized SRD-derived facts remain CC BY 4.0 with exact attribution and modification marking. Project-authored contract, disposition, selection, and audit structure is BSD-3-Clause where copyright applies. |
...
The recorded official PDF SHA-256 is `8974902d109d6e63672d7c490bde9ccf052410503d9cfa768237154fbc5e3d87`, matching `harness/provenance/srd-creatures.json`. The maintained catalog identifies SRD 5.2.1, source page/order/anchor, and official PDF identity for all 330 actual stat blocks. Its modification notice states that source facts were selected, transcribed, structured, normalized, assigned deterministic IDs, and dispositioned; substantial stat-block and trait prose is not reproduced. The historical 28-row roster remains available only through frozen refs and Git history.
