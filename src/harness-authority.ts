...
import type { Authority,CalculatorLevelBand,ControlAuthorityV2,HarnessFeatureRule } from "./types.js";
...
async function main():Promise<void>{
  ...
  const projection=projectionVersion==="2.0.0"?await createControlAuthorityProjectionV2(authorityPath):await createHarnessProjection(authorityPath);
